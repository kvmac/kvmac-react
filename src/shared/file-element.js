...
export const FileElement = ({ fill }) => {

  return (
<svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" class="eva eva-file-text-outline eva-animation eva-icon-hover-undefined" fill={fill}>
  <defs>
